    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg relative min-h-[600px]">
        ...
        <div class="w-full md:w-1/2 p-6">
          ...
          <div>
            <a href="{{ route('homestays.index') }}" class="inline-block p-4 bg-[#C1FA8F] border-2 border-black rounded-full text-gray-800 font-medium hover:bg-[#a1cf7a] hover:scale-110 transform transition duration-300">
